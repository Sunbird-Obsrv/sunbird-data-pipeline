...
import org.sunbird.dp.denorm.functions.{DenormalizationFunctionV2, SummaryDeduplicationFunctionV2}
...
/**
  ...
  */
class SummaryDenormalizationStreamTask(config: DenormalizationConfigV2, kafkaConnector: FlinkKafkaConnector) {
