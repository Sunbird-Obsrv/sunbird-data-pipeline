...
import org.sunbird.dp.denorm.task.{DenormalizationConfigV2, DenormalizationStreamTaskV2}
...
class DenormalizationStreamTaskTestSpecV2 extends BaseTestSpec {
  ...
  val denormConfig: DenormalizationConfigV2 = new DenormalizationConfigV2(config, "DenormTest")
