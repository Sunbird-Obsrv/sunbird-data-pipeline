...
object EventFixture {
  ...
  val VALID_DENORM_TELEMETRY_EVENT: String =
    """
      ...
      |"context":{"pdata":{"ver":"2.0.localstaging-debug","pid":"sunbird.app","id":"staging.diksha.app"},
  ...
  val VALID_DENORM_SUMMARY_EVENT: String =
    """
      ...
      |"pdata":{"id":"staging.diksha.portal","ver":"1.11.0","pid":"sunbird-portal.contenteditor.contentplayer"},"sid":"nlYPjt8_GoxB8LDtldOChvz7YH3odbKH",
  ...
  val VALID_LOG_EVENT: String =
    """
      ...
      |"pdata":{"id":"prod.diksha.app","pid":"learning-service","ver":"1.0"},"env":"content",
  ...
  val VALID_ERROR_EVENT: String =
    """
      ...
      |"pdata":{"id":"prod.ntp.learning.platform","pid":"learning-service","ver":"1.0"},"env":"framework"},
