...
object EventFixture {
  ...
  val userCacheDataMap1 = gson.fromJson(userCacheData1, new util.HashMap[String, String]().getClass)
  val userCacheDataMap2 = gson.fromJson(userCacheData3, new util.HashMap[String, String]().getClass)
