package org.sunbird.dp.summary.denorm.functions
...
import org.sunbird.dp.summary.denorm.task.SummaryDenormalizationConfig

class SummaryDeduplicationFunction(config: SummaryDenormalizationConfig, @transient var dedupEngine: DedupEngine = null)
