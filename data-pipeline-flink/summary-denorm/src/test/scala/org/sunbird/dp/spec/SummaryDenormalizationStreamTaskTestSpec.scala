...
import org.sunbird.dp.summary.denorm.task.{SummaryDenormalizationConfig, SummaryDenormalizationStreamTask}
...
class SummaryDenormalizationStreamTaskTestSpec extends BaseTestSpec {
  ...
  val denormConfig: SummaryDenormalizationConfig = new SummaryDenormalizationConfig(config)
