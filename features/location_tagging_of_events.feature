...
Scenario: New user on a new device at a new location
    ...
    Then my events should be tagged with my current location
...
Scenario: Existing user on a new device at an existing location
    ...
    Then my new events should be tagged with my current location
...
Scenario: Multiple child plays at single location
    ...
    Then our events should be tagged with our current location
