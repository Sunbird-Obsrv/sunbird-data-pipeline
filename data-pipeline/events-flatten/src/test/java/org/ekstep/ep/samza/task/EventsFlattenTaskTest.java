...
public class EventsFlattenTaskTest {
	...
	public void shouldRouteTelemetryEventsToTelemetryTopic() {
		...
		verify(collectorMock).send(argThat(validateEvent()));
	}

//	@Test
//	public void shouldStoreChecksumForUniqueEvents() throws Exception {
//		eventsFlattenTask = new EventsFlattenTask(deDupEngineMock, configMock, contextMock);
...
//	}
	...
	public ArgumentMatcher<OutgoingMessageEnvelope> validateEvent() {
		return new ArgumentMatcher<OutgoingMessageEnvelope>() {
			@Override
			public boolean matches(Object o) {
