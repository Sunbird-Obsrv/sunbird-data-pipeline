...
public class DeDuplicationTaskTest {
    ...
    private static final String SUCCESS_TOPIC = "telemetry.valid.temp";
    private static final String FAILED_TOPIC = "telemetry.unique.fail.temp";
    private static final String DUPLICATE_TOPIC = "telemetry.duplicate.temp";
    private static final String MALFORMED_TOPIC = "telemetry.malformed.temp";
    ...
    private DeDuplicationTaskTemp deDuplicationTask;
    ...
    public void setUp() {
        ...
        deDuplicationTask = new DeDuplicationTaskTemp(configMock, contextMock, deDuplicationStoreMock, deDupEngineMock);
    }
