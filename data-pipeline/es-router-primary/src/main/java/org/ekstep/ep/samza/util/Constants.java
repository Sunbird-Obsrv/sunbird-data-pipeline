...
public class Constants {
  ...
  public static final String AdditionalConfigDefaultPath = "/etc/es-router/config/es_router_additional.properties";
  ...
  public static final String FailedTopicDefault = "telemetry.es-sink.failed";
}
