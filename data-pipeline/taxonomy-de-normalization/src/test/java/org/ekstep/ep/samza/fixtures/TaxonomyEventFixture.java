...
public class TaxonomyEventFixture {
    ...
    public static final String LTJSON = "{\"id\":\"LT1\",\"description\":\"Read and choose Picture\",\"name\":\"Read and choose Picture\", \"parent\":\"LO9\",\"type\":\"LT\"}";
    public static final String LOJSON = "{\"id\":\"LO9\",\"description\":\"Sentence Comprehension\",\"name\":\"Sentence Comprehension\", \"parent\":\"LD5\",\"type\":\"LO\"}";
    public static final String LDJSON = "{\"id\":\"LD5\",\"description\":\"Reading Comprehension\",\"name\":\"Reading Comprehension\",\"type\":\"LD\"}";
